...
class QuantileOpTest extends SparkTestUtil {
  sparkTest("Test smvDecile") {
    ...
    [G1,k2,2,210.0,3.0,1]
    [G1,k3,3,210.0,6.0,1]
    [G1,k4,4,210.0,10.0,1]
    [G1,k5,5,210.0,15.0,1]
    [G1,k6,6,210.0,21.0,2]
    [G1,k7,7,210.0,28.0,2]
    [G1,k8,8,210.0,36.0,2]
    [G1,k9,9,210.0,45.0,3]
    [G1,k10,10,210.0,55.0,3]
    [G1,k11,11,210.0,66.0,4]
    [G1,k12,12,210.0,78.0,4]
    [G1,k13,13,210.0,91.0,5]
    [G1,k14,14,210.0,105.0,6]
    [G1,k15,15,210.0,120.0,6]
    [G1,k16,16,210.0,136.0,7]
    [G1,k17,17,210.0,153.0,8]
    [G1,k18,18,210.0,171.0,9]
    [G1,k19,19,210.0,190.0,10]
    [G1,k20,20,210.0,210.0,10]
    [G2,x,10,40.0,10.0,3]
    [G2,y,30,40.0,40.0,10]
    */
