...
object CsvAttributes {
  ...
  val defaultCsvWithHeader = new CsvAttributes(hasHeader = true, headerSize = 1)
  val defaultTsvWithHeader = new CsvAttributes(delimiter = '\t', hasHeader = true, headerSize = 1)
}
