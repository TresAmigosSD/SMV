...
```bash
$ curl https://raw.githubusercontent.com/TresAmigosSD/SMV/v1.5.2.17/tools/smv-install | bash -s -- -spark
```

## Install SMV using wget
```bash
$ wget -qO- https://raw.githubusercontent.com/TresAmigosSD/SMV/v1.5.2.17/tools/smv-install | bash -s -- -spark
```
