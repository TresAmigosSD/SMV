...
```bash
$ curl https://raw.githubusercontent.com/TresAmigosSD/SMV/v1.6.2.4.p4/tools/smv-install | bash -s -- -spark
```

## Install SMV using wget
```bash
$ wget -qO- https://raw.githubusercontent.com/TresAmigosSD/SMV/v1.6.2.4.p4/tools/smv-install | bash -s -- -spark
```
