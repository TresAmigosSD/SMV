...
```bash
$ curl https://raw.githubusercontent.com/TresAmigosSD/SMV/v2r12/tools/smv-install | bash -s -- -spark
```

## Install SMV using wget

```bash
$ wget -qO- https://raw.githubusercontent.com/TresAmigosSD/SMV/v2r12/tools/smv-install | bash -s -- -w -spark
```
